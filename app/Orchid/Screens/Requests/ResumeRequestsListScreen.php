...
class ResumeRequestsListScreen extends Screen
{
    /**
    ...
    {
        return [
            'resume_requests' => ResumeRequest::filters()->paginate(10)
        ];
    }
