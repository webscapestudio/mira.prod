    ...
    public function layout(): iterable
    {
        return [
            Layout::rows([
                ...
                Input::make('project_unit.bedrooms_quantity')->title('Bedrooms')->type('text')->required(),
                Input::make('project_unit.bathrooms_quantity')->title('Bathrooms')->type('text')->required(),
                Input::make('project_unit.floor')->title('Floor')->type('number'),
                Input::make('project_unit.view')->title('View')->type('text'),
